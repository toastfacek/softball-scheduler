    ...
    return (
      <div className="rsvp-shell rsvp-shell--centered">
        <div className="rsvp-event-card">
          ...
          <p className="rsvp-event-meta" style={{ marginTop: "0.5rem" }}>
            You won&apos;t receive any more text messages from BGSL. We&apos;ll
  ...
  return (
    <div className="rsvp-shell rsvp-shell--centered">
      <form action={confirmUnsubscribe} className="rsvp-event-card">
        <h1 className="rsvp-event-title">Turn off text messages?</h1>
        <p className="rsvp-event-meta" style={{ marginTop: "0.5rem" }}>
          You&apos;ll stop receiving texts from BGSL. Email reminders will
          continue.
        </p>
